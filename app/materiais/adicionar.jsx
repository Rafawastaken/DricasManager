...
const AdicionarMaterial = () => {
    ...
    const uploadData = async () => {
        ...
        const data = {
            nome, quantidade, precoCusto, unidade, calculoPreco, nomeImagemEncoded
        }
        ...
        try {
            ...
            setMensagem({message: "Erro ao carregadar dados: " + error.message, category: "danger"});
        } finally {
            setNome("");
            setQuantidade("");
            setPrecoCusto("");
                    ...
                    {calculoPreco && (
                        <View style={style.calculoContainer}>
                            <Text style={style.calculoLabel}>
                                Preço
                                por {unidade === "m" ? "metro" : unidade === "g" ? "grama" : "unidade"}: {calculoPreco}€
                            </Text>
                        </View>
                    )}
